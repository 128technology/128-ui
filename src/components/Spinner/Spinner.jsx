...
function Spinner({ size }) {
  ...
  return (
    <div className={className}>
      <div className="spinner__pulse-outer" />
      <div className="spinner__pulse-inner" />
      <div className="spinner__icon-outer">
        <svg className="spinner__icon" viewBox="0 0 28 13">
          <g>
            <path
              className="spinner__icon-piece"
